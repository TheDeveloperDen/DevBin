...
class TestGlobalCounterFunctions:
    ...
    def test_get_active_pastes_counter_returns_none_initially(self):
        ...
        from app.utils.active_pastes_counter import get_active_pastes_counter, set_active_pastes_counter
    ...
    def test_set_active_pastes_counter_sets_global(self):
        ...
        from app.utils.active_pastes_counter import get_active_pastes_counter, set_active_pastes_counter, ActivePastesCounter
        import app.utils.active_pastes_counter as module
