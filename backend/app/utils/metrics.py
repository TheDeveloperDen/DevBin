...
paste_operations = Counter("paste_operations_total", "Total paste operations", ["operation", "status"])
...
# Active pastes gauge
active_pastes = Gauge("active_pastes_total", "Total number of active pastes")

# Compressed pastes counter
compressed_pastes = Counter("compressed_pastes_total", "Total number of compressed pastes")

# Storage operations
storage_operations = Counter("storage_operations_total", "Total storage operations", ["operation", "backend", "status"])
